...
METRICS = (
    ...
    *_make(
        (
            ...
            "routing_oracle_recovery_accuracy",
            "routing_oracle_concept_accuracy",
            "routing_oracle_concept_stable_accuracy",
            "routing_oracle_concept_recovery_accuracy",
            ...
            "routing_meta_stable_accuracy",
            "routing_meta_recovery_accuracy",
