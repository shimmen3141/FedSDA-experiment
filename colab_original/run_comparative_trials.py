...
def run_comparative_trials(
    ...
    """
    実験を複数回回すユーティリティ。各試行ごとに res を print します。
    """
    if modes is None:
        modes = ['FedDrift', 'FedDrift_adwin_serial']
    ...
    for mode in modes:
        ...
        for i in range(n_trials):
            ...
            try:
                ...
                # もし run_random_drift_experiment が runtime_seconds を返していなければ付与
...
if __name__ == "__main__":
    modes_to_run = ['FedDrift', 'FedDrift_adwin_serial', 'NoFed_adwin_serial']
